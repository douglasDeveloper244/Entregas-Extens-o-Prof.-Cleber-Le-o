...
public class ProdutoController {
        ...
        @Operation(summary = "Cadastrar produto", description = "Cria um novo produto no sistema. É necessário informar o nome, preço, descrição, categoria e o ID do restaurante ao qual o produto pertence.")
        @ApiResponses({
