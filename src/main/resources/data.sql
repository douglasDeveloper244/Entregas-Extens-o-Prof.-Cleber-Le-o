...
-- Pizzaria Bella
('Pizza Margherita', 'Molho de tomate, muçarela e manjericão', 35.90, 'Pizza', 1, 1),
('Pizza Calabresa', 'Molho de tomate, muçarela e calabresa', 18.90, 'Pizza', 1, 1),
-- Burger House
('X-Burger', 'Pão, carne, queijo e salada', 18.90, 'Lanche', 1, 2),
('X-Bacon', 'Pão, carne, queijo, bacon e salada', 22.90, 'Lanche', 1, 2),
('Batata Frita', 'Porção de batata frita', 12.90, 'Acompanhamento', 1, 2),
-- Sushi Master
...
(1, 15.90, 15.90, 3, 8); -- Temaki Atum no pedido 3
