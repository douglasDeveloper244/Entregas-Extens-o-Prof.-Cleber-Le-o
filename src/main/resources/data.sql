...
-- Pizzaria Bella
(1, 'Pizza Margherita', 'Molho de tomate, mussarela e manjericão', 35.90, 'Pizza', 1, 1),
(2, 'Pizza Calabresa', 'Molho de tomate, mussarela e calabresa', 18.90, 'Pizza', 1, 1),
-- Burger House
(4, 'X-Burger', 'Pão, carne, queijo e salada', 18.90, 'Lanche', 1, 2),
(6, 'Batata Frita', 'Porção de batata frita crocante', 12.90, 'Acompanhamento', 1, 2),
-- Sushi Master
(7, 'Combo Sashimi', '15 peças de sashimi variado', 45.90, 'Sashimi', 1, 3),
(8, 'Hot Roll Salmão', '8 peças de hot roll de salmão', 32.90, 'Hot Roll', 1, 3),
(9, 'Temaki Atum', 'Temaki de atum com cream cheese', 15.90, 'Temaki', 1, 3);
